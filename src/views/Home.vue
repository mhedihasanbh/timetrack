...
<div class="row pt-3 pb-3">
   <div class="col-lg-3">
      <div class="dashboard-mini-chart bg-white rounded-3 py-4 px-4">
         <div class="mini-chart-top d-flex justify-content-between">
            <div class="mini-chart-left mini-chart-one">
               <h5 class="ps-2">Arrival time</h5>
               <p>+10% more</p>
            </div>
         ...
         <div class="chart-progress pt-3">
            <p class="progress-title fw-bold py-2">Progress</p>
            <div class="progress" role="progressbar" aria-label="Warning striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
               <div class="progress-bar progress-bar-striped bg-warning" style="width: 75%;background-color:#FF9F0A"></div>
            </div>
         </div>
      </div>
   </div>
   <div class="col-lg-3">
      <div class="dashboard-mini-chart bg-white rounded-3 py-4 px-4">
         <div class="mini-chart-top d-flex justify-content-between">
            <div class="mini-chart-left mini-chart-two">
               <h5 class="ps-2">Life Time</h5>
               <p>+10% more</p>
            </div>
            <div class="mini-chart-right">
               <h4>Online</h4>
         ...
         <div class="chart-progress pt-3">
            <p class="progress-title fw-bold py-2">Progress</p>
            <div class="progress" role="progressbar" aria-label="Warning striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
               <div class="progress-bar progress-bar-striped" style="width: 75%;background-color:#A701FF"></div>
            </div>
         </div>
      </div>
   </div>
   <div class="col-lg-3">
      <div class="dashboard-mini-chart bg-white rounded-3 py-4 px-4">
         <div class="mini-chart-top d-flex justify-content-between">
            <div class="mini-chart-left mini-chart-three">
               <h5 class="ps-2">Productive Time</h5>
               <p>+10% more</p>
            </div>
            <div class="mini-chart-right">
               <h4>10 M</h4>
         ...
         <div class="chart-progress pt-3">
            <p class="progress-title fw-bold py-2">Progress</p>
            <div class="progress" role="progressbar" aria-label="Warning striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
               <div class="progress-bar progress-bar-striped" style="width: 75%;background-color:#13B8A6"></div>
            </div>
         </div>
      </div>
   </div>
   <div class="col-lg-3">
      <div class="dashboard-mini-chart bg-white rounded-3 py-4 px-4">
         <div class="mini-chart-top d-flex justify-content-between">
            <div class="mini-chart-left mini-chart-four">
               <h5 class="ps-2">Desk Time</h5>
               <p>+10% more</p>
            </div>
            <div class="mini-chart-right">
               <h4>40 M</h4>
         ...
         <div class="chart-progress pt-3">
            <p class="progress-title fw-bold py-2">Progress</p>
            <div class="progress" role="progressbar" aria-label="Warning striped example" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">
               <div class="progress-bar progress-bar-striped " style="width: 75%; background-color:#EF3F36"></div>
            </div>
         </div>
      </div>
   </div>
...
<div class="row my-3">
   <div id="productivity-chart" class="bg-white rounded-3 py-4 px-4"></div>
</div>
<!-----PRODUCTIVITY CHART START----->
<!-----TABLE START----->
